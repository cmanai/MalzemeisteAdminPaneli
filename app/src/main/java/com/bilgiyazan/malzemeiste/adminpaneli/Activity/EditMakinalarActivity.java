...
public class EditMakinalarActivity extends AppCompatActivity {
    MaterialEditText model_name, kod, fiyat, description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_makinalar_layout);
            ...
            public void onClick(View v) {
                ...
                if (model_name.getText().length() != 0 && kod.getText().length() != 0 && fiyat.getText().length() != 0) {
                    ...
                    if (model_name.getText().toString().equals(getIntent().getStringExtra("Model")) && kod.getText().toString().equals(getIntent().getStringExtra("Kod"))
                            && price.equals(getIntent().getStringExtra("Fiyat")) && description.getText().toString().equals(getIntent().getStringExtra("Description"))) {
                            ...
                            public void onDataChange(DataSnapshot postSnapshot) {
                                ...
                                for (DataSnapshot dataSnapshot1 : postSnapshot.getChildren()) {
                                    ...
                                    for (DataSnapshot dataSnapshot2 : dataSnapshot1.getChildren()) {
                                        ...
                                        Query ObjectKod1 = dataSnapshot2.getRef().orderByChild("Kod").equalTo(getIntent().getStringExtra("Kod"));
                                        ObjectKod1.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot tasksSnapshot) {
                                                for (DataSnapshot snapshot : tasksSnapshot.getChildren()) {
                                                    ...
                                                    if (!description.getText().toString().equals(getIntent().getStringExtra("Description"))) {
                                                        if (description.getText().toString().isEmpty()) {

                                                            snapshot.getRef().child("Description").setValue("------");
                                                    ...
                                                    finish();
                                                    Toast.makeText(EditMakinalarActivity.this, "Ürün başarıyla güncellendi", Toast.LENGTH_SHORT).show();
                                                }
                                            }
