    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KampanyalarDetailsActivity.this, EditKampanyalarActivity.class);
        ...
        delete_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Delete_Dialog = new MaterialDialog.Builder(KampanyalarDetailsActivity.this)
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                Toast.makeText(KampanyalarDetailsActivity.this, "Ürün Silindi", Toast.LENGTH_SHORT).show();
