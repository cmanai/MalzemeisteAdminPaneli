...
public class EditMalzemeActivity extends AppCompatActivity {
    MaterialEditText model_name, kod, fiyat, renk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_malzeme_layout);
            ...
            public void onClick(View v) {
                ...
                if (model_name.getText().length() != 0 && kod.getText().length() != 0 && fiyat.getText().length() != 0) {
                    ...
                    if (model_name.getText().toString().equals(getIntent().getStringExtra("Model")) && kod.getText().toString().equals(getIntent().getStringExtra("Kod"))
                            && price.equals(getIntent().getStringExtra("Fiyat")) && renk.getText().toString().equals(getIntent().getStringExtra("Renk"))) {
...
*/
                                                            ...
                                                            finish();
                                                            Toast.makeText(EditMalzemeActivity.this, "Ürün başarıyla güncellendi", Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
