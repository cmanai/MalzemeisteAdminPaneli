...
public class MakinalarDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MakinalarDetailsActivity.this, EditMakinalarActivity.class);
        ...
        delete_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Delete_Dialog = new MaterialDialog.Builder(MakinalarDetailsActivity.this)
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                Toast.makeText(MakinalarDetailsActivity.this, "Ürün Silindi", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            Details_description_value.setText(data.getStringExtra("Description"));
