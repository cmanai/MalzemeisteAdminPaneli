...
public class EditKampanyalarActivity extends AppCompatActivity {
    MaterialEditText model_name, kod, fiyat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_kampanyalar_layout);
            ...
            public void onClick(View v) {
                ...
                if (model_name.getText().length() != 0 && kod.getText().length() != 0 && fiyat.getText().length() != 0) {
                    ...
                    if (model_name.getText().toString().equals(getIntent().getStringExtra("Model")) && kod.getText().toString().equals(getIntent().getStringExtra("Kod"))
                            && price.equals(getIntent().getStringExtra("Fiyat"))) {
...
*/
                                                ...
                                                finish();
                                                Toast.makeText(EditKampanyalarActivity.this, "Ürün başarıyla güncellendi", Toast.LENGTH_SHORT).show();
                                            }
                                        }
