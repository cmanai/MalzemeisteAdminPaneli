...
//        Details_Link_value.setText(getIntent().getStringExtra("Share_Link"));
        ...
        edit_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MalzemeDetailsActivity.this, EditMalzemeActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

                intent.putExtra("Model", getIntent().getStringExtra("Model"));
                intent.putExtra("Image", getIntent().getStringExtra("Image"));
                intent.putExtra("Kod", getIntent().getStringExtra("Kod"));
                intent.putExtra("Uyumlu", getIntent().getStringExtra("Uyumlu"));
        ...
        delete_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Delete_Dialog = new MaterialDialog.Builder(MalzemeDetailsActivity.this)
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                Toast.makeText(MalzemeDetailsActivity.this, "Ürün Silindi", Toast.LENGTH_SHORT).show();
                                            ...
                                            for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                ...
                                                for (DataSnapshot dataSnapshot3 : dataSnapshot2.getChildren()) {
                                                    for (DataSnapshot dataSnapshot4 : dataSnapshot3.getChildren()) {
                                                        Query ObjectKod1 = dataSnapshot4.getRef().orderByChild("Kod").equalTo(Kod);
